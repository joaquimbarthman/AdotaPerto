      ...
      <main className="mx-auto max-w-[1200px] px-5 pb-24 pt-8 sm:px-10 lg:px-20">
        <section className="relative overflow-hidden rounded-2xl bg-white p-5 shadow-[0_4px_12px_rgba(38,51,43,0.05)] sm:p-6">
          ...
          <div className="relative flex flex-col items-center gap-5 sm:flex-row sm:items-start">
            ...
            <button className="inline-flex shrink-0 items-center gap-2 rounded-full border-2 border-[#c0c9bf] px-5 py-2.5 text-sm font-semibold text-[#256441] transition hover:border-[#256441] hover:bg-[#eefdf1]"><Image src="/icons/edit.svg" alt="" width={14} height={14} />Editar perfil</button>
          </div>
        </section>
