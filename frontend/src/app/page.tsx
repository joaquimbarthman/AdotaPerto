...
const shortcuts = [
  ...
  { label: "Doações", href: "/doacoes", icon: "/icons/doacoes.svg", background: "bg-[#ffdcbf]" },
      ...
      <main>
        <section className="mx-auto flex min-h-[614px] max-w-[1200px] flex-col items-center justify-center px-5 py-20 text-center sm:px-10 lg:px-20 lg:py-[121px]">
          ...
          <div className="mt-12 flex flex-col gap-4 sm:flex-row sm:gap-6">
            ...
            <Link href="/doacoes" className="rounded-full bg-[#feb063] px-8 py-4 text-sm font-semibold tracking-[0.05em] text-[#764200] shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#f5a24e] hover:shadow-md active:scale-[0.98]">Quero ajudar</Link>
          </div>
        </section>
