...
function EmptyItems({ filtered }: { filtered: boolean }) {
  return <EmptyState message={filtered ? "Nenhum item encontrado com esses filtros." : "Nenhum item disponível agora."} description={filtered ? "Tente remover alguns filtros para ampliar os resultados." : "Novos itens para doação aparecerão aqui assim que forem publicados."} />;
}
